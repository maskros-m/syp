        ...
        <div id="wrapper" class="row">
			...
			<div id="loginwrapper">
				<div id="container" class="col">
					...
					<div id="login">
						<span class="border-black block behind-text text-centre mt-horizontal-line"><span><h1>Kundenkonto erstellen</h1></span></span>
					</div>
					...
					<div id="logintable">
						...
						<div id="label-fname" class="formwrapper relative">
							...
							<div class="flex"><input type="text" name="firstName" placeholder="Ihr Vorname" value="<?php echo $firstName; ?>" required /></div>
						</div>		
						...
						<div id="label-lname" class="formwrapper relative">
							...
							<div class="flex"><input type="text" name="lastName" placeholder="Ihr Nachname" value="<?php echo $lastName; ?>" required /></div>
						</div>
						...
						<div id="label-dob" class="formwrapper relative">
							...
							<div class="flex"><input type="date" name="birthDate" placeholder="" value="<?php echo $birthDate; ?>" required /></div>
						</div>
						...
						<div id="label-email" class="formwrapper relative">
							...
							<div class="flex"><input type="text" name="email" placeholder="Email-Adresse" value="<?php echo $email; ?>" required /></div>
						</div>
						...
						<div id="label-phone" class="formwrapper relative">
							...
							<div class="flex"><input type="number" name="phone" placeholder="Telefonnummer" value="<?php echo $phone; ?>" /></div>
						</div>
						...
						<div id="label-str" class="formwrapper relative">
							...
							<div class="flex"><input type="text" name="street" placeholder="Straße" value="<?php echo $street; ?>" required /></div>
						</div>
						...
						<div class="row flex-space">
							<div id="label-house" class="formwrapper relative halfwidth">
								...
								<div class="flex fullwidth"><input type="text" name="housenr" placeholder="Hausnummer" value="<?php echo $housenr; ?>" required /></div>
							</div>
							...
							<div id="label-postcode" class="formwrapper relative halfwidth">
								...
								<div class="flex fullwidth"><input type="text" name="plz" placeholder="8010" value="<?php echo $plz; ?>" required /></div>
							</div>
						</div>
						...
						<div id="label-ort" class="formwrapper relative">
							...
							<div class="flex"><input type="text" name="ort" placeholder="Graz" value="<?php echo $ort; ?>" required /></div>
						</div>								

						<div id="label-pwd" class="formwrapper relative">
							<label class="inline-block relative bottom-margin min-height subscript">Passwort für dieses Konto *</label>
							<div class="flex"><input type="password" name="pwd" placeholder="" required /></div>
						</div>

						<div id="label-pwd" class="formwrapper relative">
							<label class="inline-block relative bottom-margin min-height subscript">Passwort Bestätigung *</label>
